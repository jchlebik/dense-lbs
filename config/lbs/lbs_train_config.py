...
def get_config():
    ...
    # config.use_checkpoint = True           # if true, we will use a checkpoint to restore the model and continue training
    # if config.use_checkpoint:
    #     config.checkpoint_path          = "/home/xchleb07/dlbs/lbs_checkpoint/2024-04-25_11-06-58/checkpoints/" #/mnt/proj1/open-28-36/chlebik/barbora/runlogs/lbs/2024-04-21_18-04-01/checkpoints/"    # a path to the checkpoint we wish to restore
    #     config.restart_from_checkpoint  = True # if true, restart from the checkpoint provided using new config, 
